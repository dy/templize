...
_Templize_ recognizes inner templates as _InnerTemplatePart_ ([by the standard](https://github.com/WICG/webcomponents/blob/gh-pages/proposals/Template-Instantiation.md#33-conditionals-and-loops-using-nested-templates)). It also enables shortcut directives via `:attr`.
